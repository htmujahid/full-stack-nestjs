...
import { CardController } from '../server/api/desk/card/card.controller';
import { CardService } from '../server/api/desk/card/card.service';
import { Card } from '../server/api/desk/card/card.entity';
...
describe('Cards (e2e)', () => {
  ...
  beforeAll(async () => {
    ...
    const module: TestingModule = await Test.createTestingModule({
      imports: [TestModule, RouterModule.register([{ path: 'api/cards', module: TestModule }])],
    }).compile();
